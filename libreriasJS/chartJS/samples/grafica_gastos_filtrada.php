...
require('../../../scripts/conexion.php');
					$conexion=conectar();                    
	$sql=$_SESSION['gastossql'];
    $sql2=$_SESSION['gastossql2'];
	$mes='';
	$ano1='';
	if($sql!=$sql2 && $sql2!=""){
		$mes=" en ";
		$mes1=$_SESSION['mes1_gasto'];
		$ano1=$ano1 . ' de ' . $_SESSION['ano1_gasto'];
		switch($mes1){
...
<script src="../Chart.js"></script>
	<h1 style="font-family:sans-serif; margin-left:250px;">Gráfica de gastos <?php echo $mes . $ano1;?> </h1>
		<div style="width: 100%">
			...
			datasets : [
				{
					...
					data : [
						...
						while($lista=mysqli_fetch_array($resultado,MYSQLI_ASSOC)){
							...
							$resultado2=mysqli_query($conexion,$_SESSION['gastossql']);
							$contador_venta=0;
							while($lista2=mysqli_fetch_array($resultado2,MYSQLI_ASSOC)){
								if($lista2['sucursal_gasto']==$sucursal){
