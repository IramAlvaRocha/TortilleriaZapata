...
<div class="row mt-3">
    <div class="col-1"></div>
    <div class="col-10 p-3 border rounded shadow p-4 mb-5">
<embed src="libreriasJS/chartJS/samples/grafica_gastos.php" type="application/pdf" width="123%" height="450px" />
</div></div></div>
...
<div class="row">
      ...
      <div class="col-8">
        ...
        <form id="form_ventas" name="filtros" method="post" action="FR_gastos_back.php">
            <!--Tipo de reporte:
